...
echo.
echo.
echo     Z. A. L.    1.3v (Formal)    UPDATE : 2021. 03. 12
echo.
echo.
echo                                              .@DIMISEUNG
echo ========================================================
...
echo         [ 전체 안내 사항 ]
echo.
echo  Version 1.3부터는 자가 진단을 지원 합니다.
echo.
echo *** ' 자가진단 ' 을 입력해주시면 자가진단 링크로 이동합니다.
echo.
...
if %str% == 자가진단 goto start자가진단
if %str% == wkrkwlseks goto start자가진단
goto erro2
...
:start5반미술
start https://zoom.us/j/5135798594?pwd=WUtWMHdVTUJhVU8xSUlsd1JnaWkwQT09#success
echo ========================================================
echo.
echo               이용해주셔서 감사합니다!
echo.
